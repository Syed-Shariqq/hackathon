  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <a
          href="#cta"
          className="hidden lg:inline-flex items-center bg-[#C9A84C] text-[#1B1F3B] font-bold px-5 py-2 rounded-full hover:scale-105 transition-transform duration-300 text-sm"
        >
          Apply Now
        </a>
